    ...
    <section className="about" aria-labelledby="anchor1">
      ...
      <div className="about-message">
        <p>
          ...
          Whether you’re Vietnamese or just curious, everyone is welcome! Stay
      ...
      <div className="about-instagram" aria-label="Instagram feed">
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/reel/DFY6st3PrvS/"
          data-instgrm-version="14"
        />
        <blockquote
          className="instagram-media"
          data-instgrm-permalink="https://www.instagram.com/reel/DGyqei4PkhM/"
          data-instgrm-version="14"
        />
      </div>
    </section>
